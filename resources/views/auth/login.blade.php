...
<body>
    ...
    <div class="auth-page-wrapper pt-5">
        ...
        <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
            ...
            <canvas class="particles-js-canvas-el" width="1920" height="380" style="width: 100%; height: 100%;"></canvas>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                    ...
                                    <div class="p-2 mt-4">
                                        <form action="index.html">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" type="text" class="form-control" id="username" placeholder="Ingresa usuario" required autofocus>
                                                @if ($errors->has('email'))
                                            ...
                                            <div class="mb-3">
                                                <div class="float-end">
                                                    <a href="{{ route('ipdp.recupera_contrasena') }}" class="text-muted" style="display: none;">¿Olvidaste Contraseña?</a>
                                                </div>
                                                <label class="form-label" for="password-input">Contraseña</label>
                                                <div class="position-relative auth-pass-inputgroup mb-3">
                                                    <input name="password" type="password" class="form-control pe-5" placeholder="Ingresa contraseña" id="password-input">
                        ...
                        <div class="mt-4 text-center" style="display: none;">
                            <p class="mb-0">¿No tienes cuenta? <a href="auth-signup-basic.html" class="fw-semibold text-primary text-decoration-underline"> Registrarse</a> </p>
                        </div>
