                ...
                <div id="formHeader:sidebar1" class="ui-sidebar ui-widget ui-widget-content ui-shadow  ui-sidebar-left"
                    ...
                    <div id="formHeader:idGridMenuSidebarLogo" class="ui-panelgrid ui-widget ui-panelgrid-blank "
                        ...
                        <div id="formHeader:idGridMenuSidebarLogo_content"
                            class="ui-panelgrid-content ui-widget-content ui-grid ui-grid-responsive">
                            <div class="ui-grid-row">
                                <div class="ui-panelgrid-cell ui-grid-col-12 ZeroPadding"><a
                                        href="https://www.cdmx.gob.mx" class="ui-link ui-widget" target="_blank"><img
                                            src="https://cdmx.gob.mx/resources/img/adip-header2.svg"
                                            style="float: left;" class="img-header"></a></div>
                                <div class="ui-panelgrid-cell ui-grid-col-12 ZeroPadding opcionxmenuGreen"><a
                                        id="formHeader:j_idt44" href="#" class="ui-commandlink ui-widget"
                                        onclick="PF('sidebar1').hide();PrimeFaces.ab({s:&quot;formHeader:j_idt44&quot;});return false;"><img
                                            ...
                                            style="width: 25px;position: relative; float: right;"></a></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                                        ...
                                        <tbody class="list form-check-all" id="ticket-list-data">
                                            <tr>
                                                ...
                                                <td class="id">
                                                    <a href="javascript:void(0);" class="fw-medium link-primary ticket-id">{{ $cedula->folio }}</a></td>
                                                <td class="tasks_name">
                                                    <!-- 21/07/2022 -->
                                                    {{ $cedula->created_at }}
                                                </td>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <input class="form-check-input" type="radio" name="optionGenero"
                                                                                id="generoHombre" value="Hombre" disabled checked>
                            ...
                            <div class="grid pt-5">
                                ...
                                <div class="lg:col-2 md:col-3 sm:col-12 xs:col-12">
                                    <div class="grid p-0">
                                        ...
                                        <div class="col-12">
                                            <div class="grid p-0">
                                                <div class="col-3"><a href="https://es-la.facebook.com/GobiernoCDMX/"
                                                ...
                                                <div class="col-3"><a href="https://twitter.com/GobCDMX"
                                                        class="ui-link ui-widget" target="_blank"><img id="j_idt414"
