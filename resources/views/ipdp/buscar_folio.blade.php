...
<head>
    ...
    <meta charset="utf-8">
    <title>Login | Administrador PROYECTOS DEL PLAN GENERAL DE DESARROLLO Y DEL PROGRAMA GENERAL DE ORDENAMIENTO TERRITORIAL</title>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{ asset('/imgs/adip-header2.svg') }}"
                                        alt="" height="80">
                                </a>
                            </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form action="index.html">
                                        <div class="mb-3 text-center">
                                            <h1>SEGUIMIENTO DE FOLIOS</h1>
                                        </div>
                                        <div class="mb-3">
                                            <label for="username" class="form-label">Por favor indique el núemro de folio de su consulta:</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="email" class="form-control pe-5" id="password-input">
                                                <button
                                                    class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted"
                                                    type="button" id="password-addon">
                                                    <!-- <i class="fa-email align-middle"></i> -->
                                                </button>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">BUSCAR FOLIO</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
